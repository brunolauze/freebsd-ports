...
# GNOME 2 components
_USE_GNOME_ALL+= atk atspi cairo desktopfileutils eel2 gal2 \
		...
		gtksharp20 gtksharp30 gtksourceview gtksourceview2 gvfs libartlgpl2 libbonobo \
...
gnomedesktopsharp20_USE_GNOME_IMPL=	gnomesharp20 gtkhtml3 librsvg2 vte3 libgnomeprintui gtksourceview2 libwnck3 nautiluscdburner
...
gtksharp30_DETECT=              ${LOCALBASE}/libdata/pkgconfig/gtk-sharp-3.0.pc
gtksharp30_BUILD_DEPENDS=       ${gtksharp30_DETECT}:${PORTSDIR}/x11-toolkits/gtk-sharp30
gtksharp30_RUN_DEPENDS=         ${gtksharp30_DETECT}:${PORTSDIR}/x11-toolkits/gtk-sharp30
gtksharp30_USE_GNOME_IMPL=      gtk30
...
gnomesharp20_USE_GNOME_IMPL=	gtksharp20 librsvg2 vte3
